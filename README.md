...
- 🏆 `8x Global Hackathon Winner` & `1x CTF (Capture The Flag) Winner` : [Certificates](https://github.com/PushpenderIndia/Achievements)
...
- 🏅 Worked `651+ Hours` on [Upwork Hourly Contracts](https://www.upwork.com/freelancers/~01ee80593d3e8f9387) 
...
- 👨🏽‍💻 6 Star ⭐ Coder - CodeChef Contest Rating: `2224+`
- 👨🏽‍💻 Specialist on [Codeforces](https://codeforces.com/profile/pushpenderindia)
